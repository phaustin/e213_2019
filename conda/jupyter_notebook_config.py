...
c.NotebookApp.allow_credentials = False  # noqa
...
c.ContentsManager.default_notebook_metadata_filter = "all"  # noqa
c.ContentsManager.default_cell_metadata_filter = "all"  # noqa

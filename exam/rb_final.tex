...
\item The component of diffusive flux in the $l$ direction is given by $j=-D{dc\over dl}$, where $dl~[L]$ is the distance in the $l$ direction and $D~[L/T]$ is the diffusion coefficient. This is the non-porous-media form of Fick's law.
\end{enumerate}
\end{description}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%      FIGURE OF MESH           %%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item [Q3a]  \textbf{[3 points]} Write the equations in terms of the variables $x_0$, $x_1$, $\ldots$ (pythonic convention, beginning with zero) given by the first, second and last rows of the linear system. 

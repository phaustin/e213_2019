...
# %% {"lines_to_next_cell": 2, "nbgrader": {"grade": false, "grade_id": "cell-4835970fca5f66f9", "locked": false, "schema_version": 1, "solution": true}}
### BEGIN SOLUTION
y = 7
### END SOLUTION
...
# %% {"lines_to_next_cell": 2, "nbgrader": {"grade": true, "grade_id": "cell-9362f71eb05dffad", "locked": true, "points": 2, "schema_version": 1, "solution": false}}
...
# %% {"lines_to_next_cell": 2, "nbgrader": {"grade": true, "grade_id": "cell-ec6af3f7c1328375", "locked": false, "points": 2, "schema_version": 1, "solution": true}}


# %% [markdown]
# **c)** Change the value of `y` to `9`. What is the value of `two_y` now, `14` or `18`?

# %% {"lines_to_next_cell": 2, "nbgrader": {"grade": true, "grade_id": "cell-886acb4e6655300d", "locked": false, "points": 3, "schema_version": 1, "solution": true}}
...
# %% {"nbgrader": {"grade": true, "grade_id": "cell-ef51470651518f36", "locked": false, "points": 2, "schema_version": 1, "solution": true}}
### BEGIN SOLUTION
def convert_celsius(temp_celsius):
    temp_faren = 1.8 * temp_celsius + 32
    return temp_faren
...
# %% {"nbgrader": {"grade": false, "grade_id": "cell-ec6800b6465d8a7b", "locked": false, "schema_version": 1, "solution": true}}
### BEGIN SOLUTION
temp_F = convert_celsius(15)
### END SOLUTION
...
# %% {"nbgrader": {"grade": true, "grade_id": "cell-7aeb0c61250c5a72", "locked": true, "points": 2, "schema_version": 1, "solution": false}}
# This cell contains a hiddent test that calls your function with another value for temp_celsius

### BEGIN HIDDEN TESTS
temp_F = convert_celsius(30)
assert_almost_equal(temp_F, 86.0, decimal=1)
### END HIDDEN TESTS

...
#
# We can begin our investigation by opening the data file in JupyterLab by right-clicking on the `data/Kumpula-June-2016-w-metadata.txt` data file and selecting **Open**.
#

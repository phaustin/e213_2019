def conduction_quiz(answer):
    ...
    response = {
        ...
        "Hint 1": "Think physically!",
        "Hint 2": "Suppose that the object is warmer than its surroundings (i.e. T-Ta > 0).  Think about what this means for the signs of the terms in the differential equation ....",
    }
    try:
...
def interpolation_quiz(answer):
    ...
    response = {
        "True": "This is sometimes true, but not always. See the hint if you want some help.",
...
def discretization_quiz(answer):
    ...
    response = {
        "A": "You're on the right track, but this would be closer to a definition of the entire discipline of numerical analysis. Try something a bit more specific.",
        "B": "That's right!",
